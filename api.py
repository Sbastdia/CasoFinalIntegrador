...
# Definir la función preprocess_date
...
def predict():
    ...
    # Preprocesar los datos (ajustar según cómo se preprocesaron los datos durante el entrenamiento)
    def preprocess_input(data_from_request):
        ...
        processed_date = preprocess_date(invoice_date)  # Necesitas implementar esta función
